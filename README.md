...
- **The UI**: The initial design was prototyped by Claude Design, though the look and feel has drifted since then. The original Svelte implementation was generated by Claude Opus, but I have since refacted and cleaned it up into idiomatic, component-based Svelte myself.
