...
<span
  class="inline-flex items-center gap-2 rounded-full border border-border bg-surface-0 px-2.5 py-1.25 font-mono text-[11px] text-text-dim before:animate-pulse before:h-1.75 before:w-1.75 before:rounded-full before:content-[''] {tone[
    info.cls
  ]}"
>
  {info.label}
